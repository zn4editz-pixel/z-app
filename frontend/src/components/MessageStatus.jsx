  ...
  if (isSending) {
    return (
      <div className="flex items-center ml-1" title="Sending...">
        <svg className="w-3 h-3 text-base-content/50 animate-pulse" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  if (isRead) {
    return (
      <div className="flex items-center ml-1" title="Read">
        {/* Double Tick (Read) - Exact match from Sidebar */}
    ...
    return (
      <div className="flex items-center ml-1" title="Delivered">
        ...
        <svg className="w-4 h-4 text-base-content/50" fill="currentColor" viewBox="0 0 16 16">
          <path d="M12.354 4.354a.5.5 0 0 0-.708-.708L5 10.293 1.854 7.146a.5.5 0 1 0-.708.708l3.5 3.5a.5.5 0 0 0 .708 0l7-7zm-4.208 7-.896-.897.707-.707.543.543 6.646-6.647a.5.5 0 0 1 .708.708l-7 7a.5.5 0 0 1-.708 0z" />
          <path d="m5.354 7.146.896.897-.707.707-.897-.896a.5.5 0 1 1 .708-.708z" />
        </svg>
      </div>
