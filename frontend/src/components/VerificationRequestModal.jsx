        ...
        <form onSubmit={handleSubmit} className="p-4 sm:p-6 space-y-4">
          ...
          <div className="bg-primary/10 border border-primary/20 rounded-lg p-4">
            ...
            <p className="text-sm text-base-content/70">
              Get a blue checkmark next to your name to show you're verified.
              This helps others know you're authentic.
            </p>
          </div>
          {/* Reason */}
          ...
          <div className="text-xs text-base-content/60 bg-base-200 p-3 rounded-lg">
            <strong>Note:</strong> Your information will be reviewed by our
            team. This process may take 1-3 business days.
          </div>
          {/* Actions */}
