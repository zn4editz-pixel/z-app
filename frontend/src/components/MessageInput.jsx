    ...
    <>
      ...
      >
        ...
        >
          ...
          />
          {/* Text Input Container - FULL PILL SHAPE */}
          <div className="flex-1 flex items-center gap-2 bg-base-200/50 backdrop-blur-sm rounded-full px-4 py-2 md:px-5 md:py-3 min-w-0 border border-base-300/20 shadow-sm hover:shadow-md transition-all duration-200 my-1">
            <input
              ref={inputRef}
              type="text"
              className="flex-1 bg-transparent outline-none border-none text-base md:text-[1.05rem] placeholder:text-base-content/40 min-w-0 font-normal leading-relaxed"
              placeholder="Message..."
              value={text}
