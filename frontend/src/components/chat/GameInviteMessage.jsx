...
import { Gamepad2, AlertCircle, PlayCircle, Clock, Swords, Trophy, RefreshCw } from 'lucide-react';
...
const GameInviteMessage = ({ message, onJoin }) => {
    ...
    const myScore = isActiveGame && gameState?.players?.[authUser?.id]?.score || 0;
                    ...
                    <div className="p-3 sm:p-4">
                        ...
                        <div className="flex items-center justify-center gap-4 mb-3">
                            ...
                            <div className="flex flex-col items-center">
                                ...
                                />
                                <span className="text-white text-lg font-black mt-1">{myScore}</span>
                            ...
                            <div className="flex flex-col items-center">
                                ...
                                />
                                <span className="text-white text-lg font-black mt-1">{opponentScore}</span>
                                <span className="text-white/70 text-[10px]">{opponent?.name || 'Opponent'}</span>
                            </div>
                        </div>
                ...
                <div className="relative overflow-hidden rounded-2xl p-4 bg-base-300 border border-base-content/10 grayscale opacity-60">
                    <div className="flex items-center gap-4">
                        ...
                        <div className="flex-1">
                            ...
                            <p className="text-xs text-base-content/40">This game invite has timed out.</p>
                        </div>
                    </div>
                </div>
            </div>
