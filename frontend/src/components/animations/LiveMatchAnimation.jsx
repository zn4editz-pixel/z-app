      ...
      while (isMounted) {
        ...
        setTimeout(
          () =>
            setMessages((p) => [
              ...p,
              { text: "Accepted! Let's chat.", align: "right" },
            ]),
          1500,
        );
  ...
  return (
    <div className="w-full h-full bg-base-200 flex flex-col items-center justify-center p-8 text-center relative overflow-hidden">
      ...
      <div className="relative w-full max-w-[320px] h-64 flex items-center justify-center z-10 perspective-1000">
        ...
        >
          <div
            className={`flex-1 ${charA.bg} flex items-center justify-center relative backdrop-blur-sm transition-colors duration-500`}
          >
            <div
        ...
        >
          <div
            className={`flex-1 ${charB.bg} flex items-center justify-center relative transition-colors duration-500`}
          >
            {step < 2 && (
              <>
                ...
                <span className="text-5xl font-bold text-base-content/10 select-none">
                  ?
                </span>
              </>
            )}
