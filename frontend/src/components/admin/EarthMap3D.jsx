        ...
        <div className="absolute top-2 right-2 bg-black bg-opacity-60 rounded p-2">
          <div className="flex items-center gap-1 text-xs">
            ...
            <span className="text-white">
              {locationData
                .reduce((sum, loc) => sum + (loc.users || 0), 0)
                .toLocaleString()}
            </span>
          </div>
          <div className="flex items-center gap-1 text-xs">
            ...
            <div className="space-y-2 text-sm">
              <div className="flex justify-between">
                ...
                <span className="text-white font-bold">
                  {selectedCountry.totalUsers?.toLocaleString()}
                </span>
              </div>
              <div className="flex justify-between">
                <span className="text-gray-300">Active:</span>
                <span className="text-green-400 font-bold">
                  {selectedCountry.activeUsers?.toLocaleString()}
                </span>
              </div>
              <div className="flex justify-between">
                <span className="text-gray-300">New:</span>
                <span className="text-blue-400 font-bold">
                  {selectedCountry.newUsers?.toLocaleString()}
                </span>
              </div>
              <div className="flex justify-between">
