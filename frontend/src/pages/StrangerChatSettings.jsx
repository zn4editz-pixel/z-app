    ...
    <div className="min-h-screen bg-gradient-to-br from-base-200 to-base-300 p-4">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="flex items-center gap-4 mb-8">
          ...
          <div>
            ...
            <p className="text-base-content/70">
              Choose what strangers can see about you
            </p>
          </div>
        </div>
        {/* Preview Card */}
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-base-content/70">
                      Let strangers see your{" "}
                      {authUser?.nickname ? "nickname" : "username"}
                    </p>
                  </div>
                </div>
                <input
        ...
        <div className="flex gap-4">
          <button onClick={saveSettings} className="btn btn-outline flex-1">
