  ...
  const checkQuality = async () => {
    try {
      ...
      if (inboundRtp) {
        ...
        const lossRate =
          quality.packetsLost / (quality.packetsReceived + quality.packetsLost);
        const isHighQuality =
          quality.frameWidth >= 1920 && quality.framesPerSecond >= 25;
...
export const getQualityDescription = (connectionInfo) => {
  ...
  if (downlink >= 50 && effectiveType === "5g") {
    return {
      ...
      description: "4K 60fps - Ultra High Quality",
    };
  }
  if (downlink >= 25) {
    return {
      ...
      description: "4K 30fps - High Quality",
    };
  }
  if (downlink >= 15) {
    return {
      level: "1440p",
      color: "text-blue-400",
      description: "1440p 30fps - Very Good Quality",
    };
  }
  if (downlink >= 10) {
    return {
      level: "1080p",
      color: "text-blue-300",
      description: "1080p 30fps - Good Quality",
    };
  }
  if (downlink >= 5) {
    return {
      ...
      description: "720p 24fps - Standard Quality",
    };
  }
  return {
    level: "480p",
    color: "text-orange-400",
    description: "480p 24fps - Basic Quality",
  };
};
export default {
