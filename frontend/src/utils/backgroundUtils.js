...
export const getBackgroundClass = (componentType, options = {}) => {
  ...
  if (mobile) {
    switch (componentType) {
      case "header":
        return backgroundZones.mobileHeader;
      case "nav":
        return backgroundZones.mobileNav;
      case "card":
        return backgroundZones.mobileCard;
      default:
  ...
  switch (componentType) {
    ...
    case "section":
      switch (position) {
        case "odd":
          return backgroundZones.bright;
        case "even":
          return backgroundZones.elevated;
        case "accent":
          return backgroundZones.accentLight;
        default:
          return backgroundZones.main;
      }
    case "chat":
    ...
    case "profile":
      switch (position) {
        case "header":
          return backgroundZones.gradientBright;
        case "stats":
          return backgroundZones.dark;
        case "section":
          return backgroundZones.elevated;
  ...
  switch (type) {
    ...
    case "discover-users":
      ...
      return pattern === 0 || pattern === 3
        ? backgroundZones.elevated
        : backgroundZones.bright;
    default:
...
export const getResponsiveBackground = (componentType, options = {}) => {
  ...
  const mobile = getBackgroundClass(componentType, {
    ...options,
    mobile: true,
  });
  return {
...
export const backgroundPresets = {
  ...
  hoverCard: () =>
    combineBackgrounds(
      backgroundZones.card,
      backgroundAnimations.hover,
      backgroundAnimations.transition,
    ),
  interactiveZone: () =>
    combineBackgrounds(
      backgroundZones.elevated,
      backgroundAnimations.interactive,
    ),
  // Mobile patterns
