...
export const addPageTransition = (element) => {
  ...
  element.style.animation = 'pageSlideIn 0.3s cubic-bezier(0.25, 0.46, 0.45, 0.94) forwards';
};

// Smooth scroll enhancement
export const enhanceSmoothScroll = () => {
  // Add smooth scrolling to all scrollable elements
  const scrollableElements = document.querySelectorAll('[class*="overflow"], .scrollable');
...
export const enhanceCards = () => {
  const cards = document.querySelectorAll('.card, [class*="bg-base-"], [class*="rounded"]');
