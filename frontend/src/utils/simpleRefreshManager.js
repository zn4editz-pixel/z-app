...
export const showRefreshSpinner = (message) =>
  simpleRefreshManager.showSpinner(message);
export const hideRefreshSpinner = () => simpleRefreshManager.hideSpinner();
export const setRefreshProgress = (progress, message) =>
  simpleRefreshManager.setProgress(progress, message);
export const subscribeToRefresh = (callback) =>
  simpleRefreshManager.subscribe(callback);
